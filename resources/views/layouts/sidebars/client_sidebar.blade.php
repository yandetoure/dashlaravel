...
<div id="sidebar" class="sidebar">
    ...
    <div class="sidebar-links">
        <ul class="nav nav-pills flex-column mb-auto">
            <!-- Réservations -->
            <li><a href="{{ route('dashboard.client') }}" class="nav-link"><span class="material-icons">assignment</span> Tableau de bord</a></li>

            <li><a href="{{ route('reservations.client.mes') }}" class="nav-link"><span class="material-icons">assignment</span> Mes réservations</a></li>
