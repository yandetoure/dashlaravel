...
<body>
    ...
    <!-- Sidebar -->
    <div id="sidebar">
        <div class="sticky-header d-flex align-items-center border-bottom pb-3">
            <div class="me-3">
            ...
            <div>
                ...
                <small class="text-opacity-75">{{ Auth::user()->getRoleNames()->first() }}</small>
            </div>
        </div>
        ...
        <div class="sidebar-links">
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <h6>Factures</h6>
                <li><a href="{{ route('invoices.index') }}" class="nav-link {{ request()->routeIs('invoices.index') ? 'active' : '' }}"><span class="material-icons">person_add</span> Mes factures</a></li>
            </ul>
        </div>
    </div>
