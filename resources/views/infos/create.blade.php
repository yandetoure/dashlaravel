...
<div class="max-w-6xl mx-auto p-4 flex flex-col md:flex-row gap-4">
  ...
  <div class="w-full md:w-1/2 bg-white p-6 rounded shadow">
    <h2 class="text-2xl font-semibold mb-4">Ajouter une nouvelle info</h2>
    ...
    <form action="{{ route('infos.store') }}" method="POST" enctype="multipart/form-data" id="infoForm" class="space-y-4">
      @csrf
      <!-- Titre -->
      <div>
      ...
      <div class="mt-6 flex space-x-4">
        ...
        <a href="{{ route('infos.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition-colors duration-200">
            Annuler
        </a>
      </div>
    </form>
