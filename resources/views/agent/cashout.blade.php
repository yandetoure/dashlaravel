    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('agent.cashout.wave') }}" method="POST" id="wave-form" @if(!$canWithdraw) onsubmit="return false;" @endif>
                    @csrf
                ...
                <form action="{{ route('agent.cashout.orange-money') }}" method="POST" id="orange-form" class="mt-6" @if(!$canWithdraw) onsubmit="return false;" @endif>
                    @csrf
